...
import { Ban, CheckCircle, Laptop, Network, Plus, RefreshCw, ShieldAlert, Trash2 } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <Card>
         ...
         <CardContent className="space-y-4">
            <div className="border p-4 rounded-md bg-muted/20 space-y-4 md:space-y-0 md:grid md:grid-cols-12 md:gap-4 items-end">
                    ...
                    <div className="relative">
                        ...
                        {currentIp && (
                            <button 
                                ...
                                className="absolute right-2 top-1/2 -translate-y-1/2 text-[10px] text-indigo-600 hover:underline flex gap-1 items-center"
                            >
                                <Laptop className="h-3 w-3"/> My IP
                            </button>
                        )}
                    </div>
                </div>
                ...
                <div className="md:col-span-2 pt-2">
                    <Button 
                        ...
                        className={`w-full ${newAction === "BLOCK" ? "bg-rose-600 hover:bg-rose-700" : ""}`}
                    >
