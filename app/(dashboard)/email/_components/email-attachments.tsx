//app/(dashboard)/email/_components/email-attachments.tsx
"use client";
...
export function EmailAttachments({ attachments }: { attachments?: EmailAttachment[] }) {
